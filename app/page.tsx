...
const treeFruits = [
  { emoji: "\u{1F34E}", label: "Performance Tracking", position: { x: -90, y: -60 } },
  { emoji: "\u{1F34A}", label: "Self-awareness", position: { x: 90, y: -40 } },
  { emoji: "\u{1F347}", label: "Motivation", position: { x: -70, y: 40 } },
  { emoji: "\u{1F352}", label: "Confidence", position: { x: 80, y: 60 } },
];
